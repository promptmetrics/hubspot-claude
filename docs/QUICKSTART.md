...
```bash
git clone <repo-url> /Users/izzy/Documents/hubspot
cd /Users/izzy/Documents/hubspot
pip install -e ".[dev]"
```
...
```bash
export PYTHONPATH="/Users/izzy/Documents/hubspot/src:$PYTHONPATH"
```
...
The agent routes each request to the correct specialist out of 13 sub-agents: **objects, properties, workflows, lists, pipelines, users, hygiene, analytics, associations, engagements, custom_objects, service, raw_api**.
