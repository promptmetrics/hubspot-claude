...
_DOMAIN = (
    "You manage communications in HubSpot. "
    "You retrieve, search, create, update, and delete communication records "
    "(WhatsApp, LinkedIn, SMS logging)."
)

_DEFAULT_OBJECT_TYPE = "communications"
...
_STOP_WORDS = {
    ...
    "change", "edit", "modify", "delete", "remove", "communication", "communications",
...
def get_communications_agent_prompt(portal_config: PortalConfig | None = None) -> AgentPrompt:
...
@register_preview("communications")
async def _build_communications_preview(
    agent_name: str,
    intent: TaskIntent,
    client,
    portal_id: str,
...
@register_execute("communications")
async def _execute_communications(
    agent_name: str,
    intent: TaskIntent,
    request_text: str,
    client,
...
@register_reconcile("communications")
async def _reconcile_communications(
    agent_name: str,
    intent: TaskIntent,
    request_text: str,
    client,
