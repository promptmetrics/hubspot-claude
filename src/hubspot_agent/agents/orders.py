...
_DOMAIN = (
    "You manage HubSpot commerce orders. "
    "You retrieve, search, create, update, and delete order records. "
    "Orders support pipelines via hs_pipeline and hs_pipeline_stage properties."
)

_DEFAULT_OBJECT_TYPE = "order"
...
_STOP_WORDS = {
    ...
    "change", "edit", "modify", "delete", "remove", "order", "orders",
}
...
def get_orders_agent_prompt(portal_config: PortalConfig | None = None) -> AgentPrompt:
...
@register_preview("orders")
async def _build_orders_preview(
    agent_name: str,
    intent: TaskIntent,
    client,
    portal_id: str,
