...
_DOMAIN = (
    "You manage projects in HubSpot. "
    "You retrieve, search, create, update, and delete project records. "
    "Projects support pipelines and full CRUD operations."
)

_DEFAULT_OBJECT_TYPE = "projects"
...
_STOP_WORDS = {
    ...
    "change", "edit", "modify", "delete", "remove", "project", "projects",
}
...
def get_projects_agent_prompt(portal_config: PortalConfig | None = None) -> AgentPrompt:
...
@register_preview("projects")
async def _build_projects_preview(
    agent_name: str,
    intent: TaskIntent,
    client,
    portal_id: str,
...
@register_execute("projects")
async def _execute_projects(
    agent_name: str,
    intent: TaskIntent,
    request_text: str,
    client,
